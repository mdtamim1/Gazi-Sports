      ...
      {config.contactInfo.whatsappNumber && (
        ...
        >
          ...
          <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M24 4C12.954 4 4 12.954 4 24c0 3.69.997 7.147 2.739 10.11L4 44l10.21-2.676A19.92 19.92 0 0 0 24 44c11.046 0 20-8.954 20-20S35.046 4 24 4z" fill="#25D366"/>
            <path fillRule="evenodd" clipRule="evenodd" d="M19.04 15.54c-.39-.88-.8-.9-1.17-.91-.3-.01-.65-.01-1-.01-.35 0-.91.13-1.39.65-.48.52-1.83 1.79-1.83 4.36 0 2.57 1.87 5.05 2.13 5.4.26.35 3.63 5.78 8.93 7.88 4.42 1.74 5.32 1.4 6.28 1.31.95-.09 3.08-1.26 3.52-2.47.43-1.22.43-2.26.3-2.48-.13-.22-.48-.35-1-.61-.52-.26-3.08-1.52-3.56-1.7-.48-.17-.83-.26-1.17.27-.35.52-1.35 1.7-1.65 2.04-.3.35-.61.39-1.13.13-.52-.26-2.2-.81-4.19-2.58-1.55-1.38-2.6-3.08-2.9-3.6-.3-.52-.03-.8.23-1.06.23-.23.52-.61.78-.91.26-.3.35-.52.52-.87.17-.35.09-.65-.04-.91-.13-.26-1.14-2.84-1.59-3.88z" fill="#fff"/>
          </svg>
        </a>
      )}
