    ...
    <div style={{ padding: '8px 0' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 800, color: 'var(--sf-text-primary)', display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <span>My Events & Achievements</span>
        </h3>
        <p style={{ margin: '4px 0 0 0', fontSize: '0.85rem', color: 'var(--sf-text-tertiary)' }}>
          Special reward codes successfully unlocked by participating in our various quiz and gaming events.
        </p>
      </div>
      ...
      {loading ? (
        ...
        >
          ...
          <h4 style={{ margin: '0 0 6px 0', fontSize: '1rem', fontWeight: 700 }}>No Completed Events Yet</h4>
          <p style={{ margin: '0 0 20px 0', fontSize: '0.85rem', color: 'var(--sf-text-tertiary)' }}>
            Participate in our live events to easily win discount coupon codes.
          </p>
          <button
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px' }}>
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '0.75rem', color: 'var(--sf-text-tertiary)' }}>
                    <Calendar size={12} />
                    <span>Achieved Date: {new Date(ach.claimed_at).toLocaleDateString('en-US')}</span>
                  </div>
                </div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span style={{ fontSize: '0.82rem', color: '#475569', fontWeight: 700 }}>Discount Code:</span>
